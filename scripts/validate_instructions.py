...
def main() -> int:
    ...
    require(bool(files), "No instruction files found.", errors)
    ...
    for path in files:
        ...
        require("## When to Apply These Patterns" in text, f"{rel}: missing `## When to Apply These Patterns` section.", errors)
    ...
    print(f"Validated {len(files)} instruction files.")
    return 0
