---
name: code-review
description: Pull request review guidance covering correctness, security, tests, performance, API contract drift, migrations, error handling, and blocking-versus-suggestion review tone.
category: development
---

# Code Review Instructions for Codex

Review code for correctness first, then for safety, operability, and maintainability; praise is optional, missed regressions are not.

## Scope
- Evaluate business logic and edge-case correctness.
- Check security, data safety, and authorization effects.
- Verify tests, performance, and error handling.
- Review API and schema contract changes.
- Classify review comments as blocking or non-blocking.
